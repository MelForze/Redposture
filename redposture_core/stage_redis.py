"""Compatibility facade for :mod:`redposture_core.modules.redis`."""
...
from .modules.redis import actions as _actions
from .modules.redis import policy as _policy
from .modules.redis import render as _render
from .modules.redis import stage as _stage

_ENTRYPOINT_NAME = "run_redis_stage"
