"""Compatibility facade for :mod:`redposture_core.modules.postgres`."""
...
from .modules.postgres import actions as _actions
from .modules.postgres import policy as _policy
from .modules.postgres import render as _render
from .modules.postgres import stage as _stage

_ENTRYPOINT_NAME = "run_postgres_stage"
