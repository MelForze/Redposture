"""Compatibility facade for :mod:`redposture_core.modules.etcd`."""
...
from .modules.etcd import actions as _actions
from .modules.etcd import policy as _policy
from .modules.etcd import render as _render
from .modules.etcd import stage as _stage

_ENTRYPOINT_NAME = "run_etcd_stage"
