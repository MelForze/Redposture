"""Compatibility facade for :mod:`redposture_core.modules.clickhouse`."""
...
from .modules.clickhouse import actions as _actions
from .modules.clickhouse import policy as _policy
from .modules.clickhouse import render as _render
from .modules.clickhouse import stage as _stage

_ENTRYPOINT_NAME = "run_clickhouse_stage"
