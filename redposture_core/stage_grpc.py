"""Compatibility facade for :mod:`redposture_core.modules.grpc`."""
...
from .modules.grpc import actions as _actions
from .modules.grpc import policy as _policy
from .modules.grpc import render as _render
from .modules.grpc import stage as _stage

_ENTRYPOINT_NAME = "run_grpc_stage"
