...
def configure_keeper_parser(
    ...
    *,
    ...
    common.add_argument(
        ...
        metavar="port",
        help=(
            "ClickHouse Keeper port spec: single port, list/range, or file "
            "(examples: 9181, 9181,19181, 9181-9183, ./ports.txt). If omitted, scans 9181."
        ),
    )
    ...
    transport.add_argument("--tls-key", dest="tls_key", default=None, metavar="file", help="TLS client key for mTLS.")
    ...
    auth.add_argument(
        ...
        default=None,
        metavar="name",
        help="Optional Keeper username or credential file for digest auth credential check.",
    )
    auth.add_argument(
        "-p",
        "--password",
        ...
        default=None,
        metavar="value",
        help="Optional Keeper password for digest auth credential check.",
    )
    ...
    actions.add_argument(
        ...
        default=None,
        metavar="path",
        help="Show one znode detail by path (example: /clickhouse/tables).",
    )
    actions.add_argument(
        "--max-znodes",
        dest="max_znodes",
        ...
        default=2000,
        metavar="count",
        help="Maximum znodes included in --show-znodes/--dump output per target.",
    )
    ...
    common.add_argument(
        ...
        choices=("json", "txt"),
        default="txt",
        help="ClickHouse Keeper audit output format for stdout/file.",
    )
