"""Compatibility facade for :mod:`redposture_core.modules.docker`."""
...
from .modules.docker import actions as _actions
from .modules.docker import policy as _policy
from .modules.docker import render as _render
from .modules.docker import stage as _stage

_ENTRYPOINT_NAME = "run_docker_stage"
