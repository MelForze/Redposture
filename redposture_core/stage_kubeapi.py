"""Compatibility facade for :mod:`redposture_core.modules.kubeapi`."""
...
from .modules.kubeapi import actions as _actions
from .modules.kubeapi import policy as _policy
from .modules.kubeapi import render as _render
from .modules.kubeapi import stage as _stage

_ENTRYPOINT_NAME = "run_kubeapi_stage"
