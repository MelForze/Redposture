...
def run_kubeapi_stage(args: argparse.Namespace, logger: AttemptLogger) -> int:
    ...
    if use_single_global_progress:
        ...
        outer_progress = start_command_progress(args, _KUBE_TAG, global_total, enabled=True, leave=True)
