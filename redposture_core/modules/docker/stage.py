...
def run_docker_stage(args: Any, logger: Any) -> int:
    ...
    if bool(getattr(args, "debug", False)):
        ...
        console.info("docker audit started:" + suffix)
    runner = AuditCommandRunner(args=args, spec=build_docker_spec(args), logger=logger, emit_line=console.plain)
    try:
