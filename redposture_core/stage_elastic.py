"""Compatibility facade for :mod:`redposture_core.modules.elastic`."""
...
from .modules.elastic import actions as _actions
from .modules.elastic import policy as _policy
from .modules.elastic import render as _render
from .modules.elastic import stage as _stage

_ENTRYPOINT_NAME = "run_elastic_stage"
