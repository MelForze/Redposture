"""Compatibility facade for :mod:`redposture_core.modules.gitlab`."""
...
from .modules.gitlab import actions as _actions
from .modules.gitlab import policy as _policy
from .modules.gitlab import render as _render
from .modules.gitlab import stage as _stage

_ENTRYPOINT_NAME = "run_gitlab_stage"
