"""Compatibility facade for :mod:`redposture_core.modules.kafka`."""
...
from .modules.kafka import actions as _actions
from .modules.kafka import policy as _policy
from .modules.kafka import render as _render
from .modules.kafka import stage as _stage

_ENTRYPOINT_NAME = "run_kafka_stage"
