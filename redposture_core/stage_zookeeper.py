"""Compatibility facade for :mod:`redposture_core.modules.zookeeper`."""
...
from .modules.zookeeper import actions as _actions
from .modules.zookeeper import policy as _policy
from .modules.zookeeper import render as _render
from .modules.zookeeper import stage as _stage

_ENTRYPOINT_NAME = "run_zookeeper_stage"
