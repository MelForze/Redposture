"""Compatibility facade for :mod:`redposture_core.modules.consul`."""
...
from .modules.consul import actions as _actions
from .modules.consul import policy as _policy
from .modules.consul import render as _render
from .modules.consul import stage as _stage

_ENTRYPOINT_NAME = "run_consul_stage"
