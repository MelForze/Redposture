"""Compatibility facade for :mod:`redposture_core.modules.qdrant`."""
...
from .modules.qdrant import actions as _actions
from .modules.qdrant import policy as _policy
from .modules.qdrant import render as _render
from .modules.qdrant import stage as _stage

_ENTRYPOINT_NAME = "run_qdrant_stage"
